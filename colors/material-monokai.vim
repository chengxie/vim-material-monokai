...
let s:darkgrey    = { "gui": "#232E33", "cterm": "232" }
...
let s:inactbg	  = { "gui": "#141a1e", "cterm": "235" }
...
"augroup BgHighlight
	...
	"au! WinLeave * set wincolor=NormalInactive nocursorline
"augroup end
...
call s:h("CursorLineNr",  { "fg": s:aqua,       "bg": s:darkgrey })
...
call s:h("VertSplit",     { "fg": s:grey,       "bg": s:darkblack })
call s:h("LineNr",        { "fg": s:coolgrey})
call s:h("SignColumn",    {                     })
...
call s:h("Comment",       { "fg": s:coolgrey,	"format": "bold,italic" })
