...
" {{{ Colors
  ...
  let s:base09=['#E6DB74', '186']	"yellow
  "let s:base09=['#A6E22E', '148']	"green
  let s:base0A=['#fac863', '221']
  "let s:base0B=['#FC3488', '197']
  let s:base0B=['#e73c50', '196']	"red
...
"let s:warning   = [s:warning[0], s:warning[0], s:warning[1], s:warning[1]]
"let s:error     = [s:error[0], s:error[0], s:error[1], s:error[1]]
